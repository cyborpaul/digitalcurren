...
export default function Dashboard(){
  ...
  const usuariosregistrados=useCallback(()=>{
    return state.usuarios.map(item=>{
      return item.cantidad;
    })
  },[state.usuarios])

  const movimientosregistrados=useCallback(()=>{
    return state.movimientos.map(item=>{
      return item.cantidad;
    })
  },[state.movimientos])

  const eventosregistrados=useCallback(()=>{
    return state.eventos.map(item=>{
      return item.cantidad;
    })
  },[state.eventos])


  const saldomovimientos=useCallback(()=>{
    return state.saldomovimientos.map(item=>{
      return <tr>
              <th>
              ...
              <th>{item.use_txt_nombre}</th>
              <th> {item.sal_double_saldo}</th>
              <th> {item.ope_txt_nombre}</th>
              <th> {item.sal_txt_fecharegistro}</th>
            </tr>

    })

  },[state.saldomovimientos])


  useEffect(() => {
    axios.get('http://inventalo.test/apidigital/api/main').then((res) => {
      console.log(res);
      setState({

          movimientos:res.data.movimientosregistrados,
          usuarios: res.data.usuariosregistrados,
          eventos:res.data.eventosregistrados,
          saldomovimientos:res.data.saldomovimientos,
...
{/*         <div className="proBanner">
      ...
      {/* INICIO DASHBOARD REPORTES DE ESTADISTICA */}
        ...
        <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
          <div className="card">
            <div className="card-body">
              <div className="row">
                <div className="col-9">
                  <div className="d-flex align-items-center align-self-start">
                    <h2 className="mb-0">{usuariosregistrados()}</h2>
                    <p className="text-success ml-2 mb-0 font-weight-medium">Usuarios</p>
                  </div>
                </div>
                <div className="col-3">
              ...
              <h6 className="text-muted font-weight-normal">Usuarios registrados en las últimas 24 horas</h6>
            </div>
          </div>
        </div>
        <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
          <div className="card">
            <div className="card-body">
              <div className="row">
                <div className="col-9">
                  <div className="d-flex align-items-center align-self-start">
                    <h2 className="mb-0">{movimientosregistrados()}</h2>
                    <p className="text-success ml-2 mb-0 font-weight-medium">Movimientos</p>
                  </div>
                </div>
                <div className="col-3">
                  <div className="icon icon-box-success">
              ...
              <h6 className="text-muted font-weight-normal">Movimientos registrados en las últimas 24 horas</h6>
            </div>
          </div>
        </div>
        <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
          <div className="card">
            <div className="card-body">
              <div className="row">
                <div className="col-9">
                  <div className="d-flex align-items-center align-self-start">
                    <h2 className="mb-0">{eventosregistrados()}</h2>
                    <p className="text-danger ml-2 mb-0 font-weight-medium">Eventos</p>
                  </div>
                </div>
                <div className="col-3">
              ...
              <h6 className="text-muted font-weight-normal">Eventos de sistema en las últimas 24 horas</h6>
            </div>
          </div>
        </div>
      </div>

      {/* FIN DASHBOARD REPORTES DE ESTADISTICA */}
...
{/*         <div className="row">
      ...
      <div className="row ">
        <div className="col-12 grid-margin">
          <div className="card">
            <div className="card-body">
              <h4 className="card-title">Últimos Movimientos</h4>
...
{/*         <div className="row">
      ...
      <div className="row">
        <div className="col-12">
          <div className="card">
            <div className="card-body">
              <h4 className="card-title">Usuarios por país</h4>
              <div className="row">
