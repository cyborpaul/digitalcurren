    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul className="nav">
            ...
            <div className="profile-desc">
              <div className="profile-pic">
                ...
                <div className="profile-name">
                  <h5 className="mb-0 font-weight-normal"><Trans> Paul Alexander</Trans></h5>
                  <span><Trans>Garcia Pilco</Trans></span>
                </div>
              </div>
              <Dropdown alignRight>
          ...
          <li className={ this.isPathActive('/recargar') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <Link className="nav-link" to="/recargar">
              <span className="menu-icon"><i className="mdi mdi-laptop"></i></span>
              <span className="menu-title"><Trans>Recarga</Trans></span>
            </Link>
          </li>
          ...
          <li className={ this.isPathActive('/basic-ui') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <div className={ this.state.basicUiMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('basicUiMenuOpen') } data-toggle="collapse">
              ...
              <span className="menu-title"><Trans>Recargar</Trans></span>
          ...
          <li className={ this.isPathActive('/form-elements') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <div className={ this.state.formElementsMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('formElementsMenuOpen') } data-toggle="collapse">
              ...
              <span className="menu-title"><Trans>Usuarios registrados</Trans></span>
              <i className="menu-arrow"></i>
            </div>
          ...
          <li className={ this.isPathActive('/tables') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <div className={ this.state.tablesMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('tablesMenuOpen') } data-toggle="collapse">
              ...
              <span className="menu-title"><Trans>Registrar sof.afiliado</Trans></span>
              <i className="menu-arrow"></i>
            </div>
          ...
          <li className={ this.isPathActive('/icons') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <div className={ this.state.iconsMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('iconsMenuOpen') } data-toggle="collapse">
              ...
              <span className="menu-title"><Trans>Bitácora</Trans></span>
              <i className="menu-arrow"></i>
            </div>
